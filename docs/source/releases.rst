...
First release of consolidated library. No changes from **0.2.1**.

Migrating from 0.0.3 to 1.0.0 (or 0.1.0)
****************************************
...
We recommend going test by test and comparing the documentation: `0.0.3 <https://ioos.github.io/qartod/code/qc.html>`_ versus `1.0.0 <https://ioos.github.io/ioos_qc/api/ioos_qc.html#module-ioos_qc.qartod>`_.
